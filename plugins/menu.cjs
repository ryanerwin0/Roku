...
var defaultMenu = {
	before: `🚩 Hai %name\n*I am a Simple WhatsApp Bot Program That Can Help You Do Something, Search And Get Data/Information Only Via WhatsApp.*`.trimStart(),
	header: '*ㄆ %category*',
	body: '◦ %cmd',
	footer: '',
	after: ``,
...
var handler = async (m, {
	...
	tags = {
		...
		'instagram': 'I N S T A G R A M - M E N U',
		'premium': 'P R E M I U M - M E N U',
		'convert': 'C O N V E R T - M E N U',
		'tiktok': 'T I K T O K - M E N U',
		'18+': 'A D U L T - M E N U',
		'weebs': 'W E E B S - M E N U',
	...
	try {
		...
		conn.reply(m.chat, Styles(text.trim()), m)
	} catch (e) {
